 ...
 * adjacent vertex of 0. If we don’t mark visited vertices, then 2 will be processed
 * again and it will become a non-terminating process. Breadth First Traversal of
...
/*
 * Following is C++ implementation of simple Breadth First Traversal from a given source.
