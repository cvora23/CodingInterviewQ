...
power of 2 is 4, after dividing 300 by 4 we get 75. Greatest divisible power of 3 is 3,
 after dividing 75 by 3 we get 25. Greatest divisible power of 5 is 25,
...
int getNthUglyNoSimpleMethod(int n)
{
  int i = 1;
...
The ugly-number sequence is 1, 2, 3, 4, 5, 6, 8, 9, 10, 12, 15, …
     ...
     multiply 2, 3, 5. Then we use similar merge method as merge sort, to get
     every ugly number from the three subsequence. Every step we choose the
...
{
	// Simple Method
    unsigned no = getNthUglyNoSimpleMethod(150);
    printf("150th ugly no. is %d \n",  no);
    // DP Method
    no = getNthUglyNoSimpleMethod(150);
    printf("150th ugly no. is %d \n",  no);
