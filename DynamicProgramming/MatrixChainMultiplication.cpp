 ...
 * computes the same subproblems again and again. See the following recursion tree for a matrix chain of size 4.
...
int main(){

	{
	    ...
	    printf("Minimum number of multiplications is %d \n",Recursion::MatrixChainOrder(arr, 1, n-1));
	}

	{
	    int arr[] = {1, 2, 3, 4, 3};
	    int n = sizeof(arr)/sizeof(arr[0]);
	    printf("Minimum number of multiplications is %d \n",DP::MatrixChainOrder(arr,n));
	}
