 ...
 * We have discussed a solution to print all possible paths, counting all paths is easier.
 * Let NumberOfPaths(m, n) be the count of paths to reach row number m and
 * column number n in the matrix, NumberOfPaths(m, n) can be recursively written as following.
 */
