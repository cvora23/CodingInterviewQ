...
: m_cpp_logger(log4cpp::Category::getRoot())
{
  ...
  log4cpp::Appender* p_appender = new log4cpp::OstreamAppender("console",
                                                               &std::cout);
...
void Log::Logger::log(Log::LogLevel level, const std::string& msg)
{
  ...
  case Log::EMERG:  cpp_level = log4cpp::Priority::EMERG;  break;
  case Log::ALERT:  cpp_level = log4cpp::Priority::ALERT;  break;
  case Log::CRIT:   cpp_level = log4cpp::Priority::CRIT;   break;
  case Log::ERROR:  cpp_level = log4cpp::Priority::ERROR;  break;
  case Log::WARN:   cpp_level = log4cpp::Priority::WARN;   break;
  case Log::NOTICE: cpp_level = log4cpp::Priority::NOTICE; break;
  case Log::INFO:   cpp_level = log4cpp::Priority::INFO;   break;
  case Log::DEBUG:  cpp_level = log4cpp::Priority::DEBUG;  break;
