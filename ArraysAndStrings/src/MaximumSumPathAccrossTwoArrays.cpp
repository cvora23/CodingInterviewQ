/*
 * MaximumSumPathAccrossTwoArrays.cpp
 *
...
Expected time complexity is O(m+n) where m is the number of elements in ar1[] and n
is the number of elements in ar2[].
 ...
 * Whenever we see a common point, we compare the two sums and add the maximum of
 * two to the result. Following are detailed steps.
 ...
 *    While traversing compare current elements of ar1[] and ar2[].
 *  2.a) If current element of ar1[] is smaller than current element of ar2[],
 *  then update sum1, else if current element of ar2[] is smaller, then update sum2.
 *  2.b) If current element of ar1[] and ar2[] are same, then take the maximum of sum1
