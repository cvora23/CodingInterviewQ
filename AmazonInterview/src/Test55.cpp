...
in a file so that it can be later restored. The structure of tree must be maintained.
sDeserialization is reading tree back from file.
...
http://d1gjlxt8vb0knt.cloudfront.net//wp-content/uploads/serializeNaryTree.png
...
// Maximum of N child allowed per node
struct Node {
   char key;
