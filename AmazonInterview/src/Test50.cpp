 ...
 */
/*
 * Given an array {2, 4, 6, 0, 1, 8, 1}, where each element represents
 * the height of tower located at its index. I was supposed to tell
 * how much maximum water can accumulate in this “valley” once it rains.
 *
 * eg: http://d1gjlxt8vb0knt.cloudfront.net//wp-content/uploads/watertrap.png
 *
 * Trapping Rain Water
...
An Efficient Solution is to prre-compute highest bar on left and right
of every bar in O(n) time. Then use these pre-computed values to find
the amount of water in every array element. Below is C++ implementation of this solution.
